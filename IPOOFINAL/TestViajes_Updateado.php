...
$responsableUno->cargarResponsable(1,"Juan", "Juanales");

$responsableDos = new Responsable();
$responsableDos->cargarResponsable(2,"Martina","Martinez");

$responsableTres = new Responsable();
$responsableTres->cargarResponsable(3,"Pedro", "Piedrita");
...
$pasajeroUno->cargarPasajero("Carmen","Carmín",27797393, 2991231234);
$pasajeroDos = new Pasajero();
$pasajeroDos->cargarPasajero("Luis", "Lucero", 38868451,2984569871);
$pasajeroTres = new Pasajero();
$pasajeroTres->cargarPasajero("Isabel", "Velero", 18479361,2991002003);
$pasajeroCuatro = new Pasajero();
$pasajeroCuatro->cargarPasajero("Laura", "Laurel", 43589741,2995558883);
$pasajeroCinco = new Pasajero();
$pasajeroCinco->cargarPasajero("Pablo", "Clavo", 20341123, 2985156669);
...
do{
    ...
    switch($opcion){
        ...
        case 13:
            ...
            if($viaje->buscar($id)){
                $viajePasajero = new ViajePasajero();
                $pasajeros = $viajePasajero->listar("viaje",$id);
                if(count($pasajeros) == 0){
                    echo "No hay pasajeros en este viaje. \n";
                }else{
                echo "Pasajeros de el viaje " . $id . ": \n";
                }
                foreach($pasajeros as $unPasajero){
                    echo $unPasajero . "\n";
                }
            }else{
                echo "El viaje de id " . $id . " no existe";
            }
        break;
    }
...
function mostrarMenu(){
    ...
    echo "13) Mostrar pasajeros del viaje.\n";
    echo "14) Salir \n";
    echo "*-------------------------------------------------* \n";
