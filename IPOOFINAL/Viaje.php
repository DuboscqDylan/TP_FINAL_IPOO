...
class Viaje{
    ...
    public function insertar(){
        ...
        if ($baseDatos->Iniciar()) {
            $consultaInsertar="INSERT INTO viaje(vdestino,vcantmaxpasajeros, idempresa, vimporte, idpersona) 
            VALUES('".$this->getDestino()."', '".$this->getCantMaxPasajeros()."', ".$this->getEmpresa()->getIdEmpresa().", '".$this->getImporte()."','".$this->getResponsable()->getIdPersona()."')";
